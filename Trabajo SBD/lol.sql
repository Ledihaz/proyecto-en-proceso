...
-- Started on 2024-06-23 22:51:51 CDT
...
CREATE TABLE public.chef (
    ...
    nombre character varying NOT NULL,
    n_receta character varying NOT NULL
);
...
-- Dependencies: 216
-- Name: COLUMN chef.no_tarjeta; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.chef.no_tarjeta IS 'Identificamos al chef por su numero de tarjeta';
...
-- Dependencies: 216
-- Name: COLUMN chef.nombre; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.chef.nombre IS 'Nombre del chef';
...
--
-- TOC entry 227 (class 1259 OID 25065)
...
-- Dependencies: 227
-- Name: COLUMN "user".no_tarjeta; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."user".no_tarjeta IS 'No tarjeta de todos los usuarios';


--
-- TOC entry 3581 (class 0 OID 0)
-- Dependencies: 227
-- Name: COLUMN "user".clave_acces; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public."user".clave_acces IS 'Clave de acceso para todos los usuarios';
...
--
-- TOC entry 3517 (class 0 OID 24761)
-- Dependencies: 215
...
--
-- TOC entry 3518 (class 0 OID 24768)
-- Dependencies: 216
-- Data for Name: chef; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.chef VALUES (8754, 1234, 5556, 'Ramon', 'pan con timba');
INSERT INTO public.chef VALUES (3452, 4665, 6534, 'Raul', 'perro azado');
INSERT INTO public.chef VALUES (4556, 4278, 9808, 'Roberto', 'wanchi');
INSERT INTO public.chef VALUES (6777, 7970, 4565, 'Ramira', 'arroz con leche');


--
-- TOC entry 3519 (class 0 OID 24775)
-- Dependencies: 217
...
INSERT INTO public.ingredientes VALUES ('arroz', 'con aceite');
INSERT INTO public.ingredientes VALUES ('pan', 'de shopy');
INSERT INTO public.ingredientes VALUES ('queso', 'gouda');
INSERT INTO public.ingredientes VALUES ('perro', 'en buen estado');
INSERT INTO public.ingredientes VALUES ('leche', 'de vaca');
INSERT INTO public.ingredientes VALUES ('jamon', 'de cerdo');
INSERT INTO public.ingredientes VALUES ('salsa criolla', 'es criolla');
INSERT INTO public.ingredientes VALUES ('sal', 'fina y blanca');


--
-- TOC entry 3528 (class 0 OID 24860)
-- Dependencies: 226
...
--
-- TOC entry 3521 (class 0 OID 24796)
-- Dependencies: 219
...
--
-- TOC entry 3522 (class 0 OID 24804)
-- Dependencies: 220
...
--
-- TOC entry 3523 (class 0 OID 24812)
-- Dependencies: 221
...
--
-- TOC entry 3524 (class 0 OID 24825)
-- Dependencies: 222
...
--
-- TOC entry 3525 (class 0 OID 24832)
-- Dependencies: 223
...
--
-- TOC entry 3526 (class 0 OID 24839)
-- Dependencies: 224
-- Data for Name: receta; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.receta VALUES ('pan con timba', 'Pan con guayaba y queso, es mi favorito');
INSERT INTO public.receta VALUES ('perro azado', 'Comida china a la orden, fan de los perros');
INSERT INTO public.receta VALUES ('wanchi', 'pan con queso, en mi enfancia me quito mucho el ambre');
INSERT INTO public.receta VALUES ('arroz con leche', 'Que viva la leche');


--
-- TOC entry 3529 (class 0 OID 25065)
-- Dependencies: 227
...
--
-- TOC entry 3527 (class 0 OID 24848)
-- Dependencies: 225
-- Data for Name: utiliza; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.utiliza VALUES (1111, 'leche', 'arroz con leche');


--
-- TOC entry 3339 (class 2606 OID 24765)
...
--
-- TOC entry 3341 (class 2606 OID 24767)
...
--
-- TOC entry 3343 (class 2606 OID 24772)
-- Name: chef chef_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chef
    ADD CONSTRAINT chef_pk PRIMARY KEY (no_tarjeta);


--
-- TOC entry 3345 (class 2606 OID 24774)
...
--
-- TOC entry 3347 (class 2606 OID 24782)
...
--
-- TOC entry 3349 (class 2606 OID 24784)
...
--
-- TOC entry 3351 (class 2606 OID 24786)
...
--
-- TOC entry 3353 (class 2606 OID 24788)
...
--
-- TOC entry 3355 (class 2606 OID 24795)
...
--
-- TOC entry 3371 (class 2606 OID 24866)
...
--
-- TOC entry 3357 (class 2606 OID 24803)
...
--
-- TOC entry 3359 (class 2606 OID 24811)
...
--
-- TOC entry 3361 (class 2606 OID 24818)
...
--
-- TOC entry 3365 (class 2606 OID 24838)
...
--
-- TOC entry 3363 (class 2606 OID 24829)
...
--
-- TOC entry 3367 (class 2606 OID 24845)
...
--
-- TOC entry 3373 (class 2606 OID 25069)
-- Name: user user_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."user"
    ADD CONSTRAINT user_pk PRIMARY KEY (no_tarjeta);


--
-- TOC entry 3369 (class 2606 OID 24852)
...
--
-- TOC entry 2085 (class 826 OID 24755)
...
-- Completed on 2024-06-23 22:51:51 CDT
